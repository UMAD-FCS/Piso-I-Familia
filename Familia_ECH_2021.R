...
sem1 <- sem1 %>% dplyr::mutate(ciclo_vida1 = case_when(ciclo_vida==1 ~ 1, ciclo_vida!=1 ~ 0)) 
sem1 <- sem1 %>% dplyr::mutate(ciclo_vida2 = case_when(ciclo_vida==2 ~ 1, ciclo_vida!=2 ~ 0)) 
sem1 <- sem1 %>% dplyr::mutate(ciclo_vida3 = case_when(ciclo_vida==3 ~ 1, ciclo_vida!=3 ~ 0)) 
sem1 <- sem1 %>% dplyr::mutate(ciclo_vida4 = case_when(ciclo_vida==4 ~ 1, ciclo_vida!=4 ~ 0)) 
sem1 <- sem1 %>% dplyr::mutate(ciclo_vida5 = case_when(ciclo_vida==5 ~ 1, ciclo_vida!=5 ~ 0)) 
sem1 <- sem1 %>% dplyr::mutate(ciclo_vida6 = case_when(ciclo_vida==6 ~ 1, ciclo_vida!=6 ~ 0)) 
sem1 <- sem1 %>% dplyr::mutate(ciclo_vida7 = case_when(ciclo_vida==7 ~ 1, ciclo_vida!=7 ~ 0)) 
sem1 <- mutate_at(sem1, c("ciclo_vida1", "ciclo_vida2", "ciclo_vida3", "ciclo_vida4", "ciclo_vida5","ciclo_vida6", "ciclo_vida7"), ~replace(., is.na(.), 0))
...
sem2_implant <- sem2_implant %>% dplyr::mutate(ciclo_vida1 = case_when(ciclo_vida==1 ~ 1, ciclo_vida!=1 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(ciclo_vida2 = case_when(ciclo_vida==2 ~ 1, ciclo_vida!=2 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(ciclo_vida3 = case_when(ciclo_vida==3 ~ 1, ciclo_vida!=3 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(ciclo_vida4 = case_when(ciclo_vida==4 ~ 1, ciclo_vida!=4 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(ciclo_vida5 = case_when(ciclo_vida==5 ~ 1, ciclo_vida!=5 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(ciclo_vida6 = case_when(ciclo_vida==6 ~ 1, ciclo_vida!=6 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(ciclo_vida7 = case_when(ciclo_vida==7 ~ 1, ciclo_vida!=7 ~ 0)) 
sem2_implant <- mutate_at(sem2_implant, c("ciclo_vida1", "ciclo_vida2", "ciclo_vida3", "ciclo_vida4", "ciclo_vida5","ciclo_vida6", "ciclo_vida7"), ~replace(., is.na(.), 0))
...
####Estado civil
sem2_implant <- sem2_implant %>% dplyr::mutate(bc_pe5 = case_when(e35==2 | e35==3 | e35==6 | e35==7 ~ 1, 
                                                    e35==4 | e35==5 ~ 2,
                                                    e35==0 & (e36==1 | e36==2 | e36==3) ~ 3,
                                                    e35==0 & (e36==4 | e36==6) ~ 4,
                                                    e35==0 & e36==5 ~ 5)) 

sem2_implant <- sem2_implant %>% dplyr::mutate(estado_civil1 = case_when(bc_pe5==1 ~ 1, bc_pe5!=1 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(estado_civil2 = case_when(bc_pe5==2 ~ 1, bc_pe5!=2 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(estado_civil3 = case_when(bc_pe5==3 ~ 1, bc_pe5!=3 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(estado_civil4 = case_when(bc_pe5==4 ~ 1, bc_pe5!=4 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(estado_civil5 = case_when(bc_pe5==5 ~ 1, bc_pe5!=5 ~ 0)) 
sem2_implant <- mutate_at(sem2_implant, c("estado_civil1", "estado_civil2", "estado_civil3", "estado_civil4", "estado_civil5"), ~replace(., is.na(.), 0))
...
###Menores de 18 
sem1 <- sem1 %>% dplyr::mutate(men0a4 = case_when(bc_pe3<5 ~ 1, bc_pe3>=5 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(men0a4 = case_when(bc_pe3<5 ~ 1, bc_pe3>=5 ~ 0)) 
sem1 <- sem1 %>% group_by(bc_correlat) %>% mutate(men0a4h=max(men0a4)) %>% as.data.frame()
sem2_implant <- sem2_implant %>% group_by(bc_correlat) %>% mutate(men0a4h=max(men0a4)) %>% as.data.frame()


sem1 <- sem1 %>% dplyr::mutate(men5a12 = case_when(bc_pe3>4&bc_pe3<13 ~ 1, bc_pe3>=12|bc_pe3<5 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(men5a12 = case_when(bc_pe3>4&bc_pe3<13 ~ 1, bc_pe3>=12|bc_pe3<5 ~ 0)) 
sem1 <- sem1 %>% group_by(bc_correlat) %>% mutate(men5a12h=max(men5a12)) %>% as.data.frame()
sem2_implant <- sem2_implant %>% group_by(bc_correlat) %>% mutate(men5a12h=max(men5a12)) %>% as.data.frame()


sem1 <- sem1 %>% dplyr::mutate(men13a17 = case_when(bc_pe3>12&bc_pe3<18 ~ 1, bc_pe3<13|bc_pe3>=18 ~ 0)) 
sem2_implant <- sem2_implant %>% dplyr::mutate(men13a17 = case_when(bc_pe3>12&bc_pe3<18 ~ 1, bc_pe3<13|bc_pe3>=18 ~ 0)) 
sem1 <- sem1 %>% group_by(bc_correlat) %>% mutate(men13a17h=max(men13a17)) %>% as.data.frame()
sem2_implant <- sem2_implant %>% group_by(bc_correlat) %>% mutate(men13a17h=max(men13a17)) %>% as.data.frame()
...
sem1 <- sem1 %>% dplyr::mutate(tramo_edad = case_when(bc_pe3>=0  & bc_pe3<=5  ~ 1,
                                                      ...
                                                      bc_pe3>=65 ~ 7))
sem1 <- sem1 %>% dplyr::mutate(tramo_edad2 = case_when(bc_pe3>=0  & bc_pe3<=29  ~ 1,
                                                       bc_pe3>=30  & bc_pe3<=44 ~ 2,
                                                       bc_pe3>=45 & bc_pe3<=64 ~ 3,
                                                       bc_pe3>=65 ~ 4))
sem1 <- sem1 %>% dplyr::mutate(tramo_edad3 = case_when(bc_pe3<=29  ~ 1,
...
sem2_implant <- sem2_implant %>% dplyr::mutate(tramo_edad = case_when(bc_pe3>=0  & bc_pe3<=5  ~ 1,
                                                                      ...
                                                                      bc_pe3>=30 & bc_pe3<=64 ~ 6,
                                                                      bc_pe3>=65 ~ 7))
sem2_implant <- sem2_implant %>% dplyr::mutate(tramo_edad2 = case_when(bc_pe3>=0  & bc_pe3<=29  ~ 1,
                                                                       bc_pe3>=30  & bc_pe3<=44 ~ 2,
                                                                       bc_pe3>=45 & bc_pe3<=64 ~ 3,
                                                                       bc_pe3>=65 ~ 4))
sem2_implant <- sem2_implant %>% dplyr::mutate(tramo_edad3 = case_when(bc_pe3<=29  ~ 1,
                                                                       bc_pe3>=30 & bc_pe3<=49 ~ 2))
...
sem1 <- sem1 %>% dplyr::mutate(identif = case_when(bc_pe4!=7 ~ 1, bc_pe4==7 ~ 0))
sem2_implant <- sem2_implant %>% dplyr::mutate(identif = case_when(bc_pe4!=7 ~ 1, bc_pe4==7 ~ 0))

sem1 <- sem1 %>% group_by(bc_correlat) %>% mutate(n_int=sum(identif)) %>% as.data.frame()
sem2_implant <- sem2_implant %>% group_by(bc_correlat) %>% mutate(n_int=sum(identif)) %>% as.data.frame()

sem1 <- sem1 %>% dplyr::mutate(nint1 = case_when(n_int==1~1))
sem1 <- sem1 %>% dplyr::mutate(nint2 = case_when(n_int==2~1))
sem1 <- sem1 %>% dplyr::mutate(nint3 = case_when(n_int==3~1))
sem1 <- sem1 %>% dplyr::mutate(nint4 = case_when(n_int==4~1))
sem1 <- sem1 %>% dplyr::mutate(nint5 = case_when(n_int>=5~1))

sem2_implant <- sem2_implant %>% dplyr::mutate(nint1 = case_when(n_int==1~1))
sem2_implant <- sem2_implant %>% dplyr::mutate(nint2 = case_when(n_int==2~1))
sem2_implant <- sem2_implant %>% dplyr::mutate(nint3 = case_when(n_int==3~1))
sem2_implant <- sem2_implant %>% dplyr::mutate(nint4 = case_when(n_int==4~1))
sem2_implant <- sem2_implant %>% dplyr::mutate(nint5 = case_when(n_int>=5~1))

sem1 <- mutate_at(sem1, c("nint1", "nint2", "nint3", "nint4", "nint5"), ~replace(., is.na(.), 0))
sem2_implant <- mutate_at(sem2_implant, c("nint1", "nint2", "nint3", "nint4", "nint5"), ~replace(., is.na(.), 0))
...
a_jefe <- function(y) {
  base <- subset(sem1_h_svy_1, sexojefe == y) 
...
b_jefe <- function(y) {
  base <- subset(sem2_implant_h_svy_1, sexojefe == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_e_jefe = matrix(, nrow = 8, ncol = 2)

for(i in 1:2){
  b_e_jefe[,i] <- b_jefe(y = i)
}
...
a_reg <- function(y) {
  base <- subset(sem1_h_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_reg <- function(y) {
  base <- subset(sem2_implant_h_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_ascen <- function(y) {
  base <- subset(sem1_h_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_ascen <- function(y) {
  base <- subset(sem2_implant_h_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_e_ascen = matrix(, nrow = 8, ncol = 2)
...
a_pobre <- function(y) {
  base <- subset(sem1_h_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_pobre <- function(y) {
  base <- subset(sem2_implant_h_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_e_pobre = matrix(, nrow = 8, ncol = 2)
...
sem1_h_svy_1_men <- sem1_h_men_svy %>%
  filter(bd_region == 1 & tipo_hogar>0)
sem2_implant_h_svy_1_men <- sem2_implant_h_men_svy %>%
  filter(bd_region == 1 & tipo_hogar>0)
...
a_jefe <- function(y) {
  base <- subset(sem1_h_svy_1_men, sexojefe == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_jefe <- function(y) {
  base <- subset(sem2_implant_h_svy_1_men, sexojefe == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_edad <- function(y) {
  base <- subset(sem1_h_svy_1_men, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_edad <- function(y) {
  base <- subset(sem2_implant_h_svy_1_men, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
# Quintil de ingreso del hogar
a_quintil <- function(y) {
  base <- subset(sem1_h_svy_1_men, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_quintil <- function(y) {
  base <- subset(sem2_implant_h_svy_1_men, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_reg <- function(y) {
  base <- subset(sem1_h_men_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_reg <- function(y) {
  base <- subset(sem2_implant_h_men_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_jefe <- function(y) {
  base <- subset(sem1_h_men_svy_1, sexojefe == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_jefe <- function(y) {
  base <- subset(sem2_implant_h_men_svy_1, sexojefe == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_edad <- function(y) {
  base <- subset(sem1_h_men_svy_1, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_edad <- function(y) {
  base <- subset(sem2_implant_h_men_svy_1, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_ascen <- function(y) {
  base <- subset(sem1_h_men_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_ascen <- function(y) {
  base <- subset(sem2_implant_h_men_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_pobre <- function(y) {
  base <- subset(sem1_h_men_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_pobre <- function(y) {
  base <- subset(sem2_implant_h_men_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_sexo <- function(y) {
  base <- subset(sem1_svy_1,  bc_pe2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_sexo <- function(y) {
  base <- subset(sem2_implant_svy_1,  bc_pe2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_edad <- function(y) {
  base <- subset(sem1_svy_1, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_edad <- function(y) {
  base <- subset(sem2_implant_svy_1, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
# Quintil de ingreso del hogar
a_quintil <- function(y) {
  base <- subset(sem1_svy_1, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_quintil <- function(y) {
  base <- subset(sem2_implant_svy_1, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_reg <- function(y) {
  base <- subset(sem1_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_reg <- function(y) {
  base <- subset(sem2_implant_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_ascen <- function(y) {
  base <- subset(sem1_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_ascen <- function(y) {
  base <- subset(sem2_implant_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_pobre <- function(y) {
  base <- subset(sem1_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_pobre <- function(y) {
  base <- subset(sem2_implant_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_e_quintil = matrix(, nrow = 7, ncol = 5)
...
b_e_ascen = matrix(, nrow = 7, ncol = 2)
...
b_e_pobre = matrix(, nrow = 7, ncol = 2)
...
b_e_ascen = matrix(, nrow = 6, ncol = 2)
...
b_e_pobre = matrix(, nrow = 6, ncol = 2)
...
c_sem <- matrix(,5,1)
for (i in 1:5) {
  c_sem[i,1] <- c(as.numeric(b_sem[1,i]))
}

colnames(c_sem) <- c("VALOR")
c_sem <- cbind(c_sem, NOMINDICADOR)
c_sem <- as.data.frame(c_sem)
BASE_MOTOR <- cbind(c_sem,BASE_AUX)
...
sem1_h_svy <- sem1_h_svy %>% dplyr::mutate(menorH=men0a4h)
sem2_implant_h_svy <- sem2_implant_h_svy %>% dplyr::mutate(menorH=men0a4h)
...
c_reg <- as.data.frame(cbind(a_e_reg, b_e_reg))
c_reg <- c_reg %>% dplyr::mutate(m_reg = (a_e_reg + b_e_reg)/2)
c_reg <- c_reg[,c("m_reg")]
c_reg_1 <- cbind(as.data.frame(c_reg[1]), NOMINDICADOR, BASE_AUX)
c_reg_1 <- c_reg_1 %>% dplyr::mutate(URBANORURALUY = "URBANO (MENOS DE 5.000 HABITANTES)")
c_reg_2 <- cbind(as.data.frame(c_reg[2]), NOMINDICADOR, BASE_AUX)
...
sem1_h_svy <- sem1_h_svy %>% dplyr::mutate(menorH=men5a12h)
sem2_implant_h_svy <- sem2_implant_h_svy %>% dplyr::mutate(menorH=men5a12h)
...
sem1_h_svy <- sem1_h_svy %>% dplyr::mutate(menorH=men13a17h)
sem2_implant_h_svy <- sem2_implant_h_svy %>% dplyr::mutate(menorH=men13a17h)
...
### 516 Distribución porcentual de hogares de 15 años con menores según tipo de hogar
...
NOMINDICADOR <- 
  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, sin menores en el hogar (Varón)",
    "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, sin menores en el hogar (Mujer)")
...
a_edad <- function(y) {
  base <- subset(sem1_svy_1, tramo_edad3 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_edad <- function(y) {
  base <- subset(sem2_implant_svy_1, tramo_edad3 == y) 
  resultados  <-  sapply(base$variables %>% select(var_int), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
c_quintil_4 <- cbind(as.data.frame(c_quintil[,4]), NOMINDICADOR, BASE_AUX)
c_quintil_4 <- c_quintil_4 %>% dplyr::mutate(QUINTIL = "Quintil 4")
c_quintil_5 <- cbind(as.data.frame(c_quintil[,2]), NOMINDICADOR, BASE_AUX)
c_quintil_5 <- c_quintil_5 %>% dplyr::mutate(QUINTIL = "Quintil 5")
colnames(c_quintil_1) <- colnames(BASE_MOTOR)
colnames(c_quintil_2) <- colnames(BASE_MOTOR)
colnames(c_quintil_3) <- colnames(BASE_MOTOR)
...
NOMINDICADOR <- 
  c(  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, sin menores en el hogar (Varón)",
        "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, sin menores en el hogar (Mujer)"))
...
NOMINDICADOR <- 
  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 4 en el hogar (Varón)",
    "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 4 en el hogar (Mujer)")
...
NOMINDICADOR <- 
  c(  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 4 en el hogar (Varón)",
        "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 4 en el hogar (Mujer)"))
...
NOMINDICADOR <- 
  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 7 en el hogar (Varón)",
    "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 7 en el hogar (Mujer)")
...
NOMINDICADOR <- 
  c(  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 7 en el hogar (Varón)",
        "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 7 en el hogar (Mujer)"))
...
NOMINDICADOR <- 
  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 13 en el hogar (Varón)",
    "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 13 en el hogar (Mujer)")
...
NOMINDICADOR <- 
  c(  c("Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 13 en el hogar (Varón)",
        "Tasa de participación de mujeres y varones entre 14 y 49 años de edad, con presencia de menores de 13 en el hogar (Mujer)"))
...
b_sem <- cbind(b_sem, NOMINDICADOR)
colnames(b_sem) <- c("VALOR", "NOMINDICADOR")
b_sem <- as.data.frame(b_sem)
BASE_MOTOR <- cbind(b_sem,BASE_AUX)
...
BASE = rbind(m500_pu, m500_tp, m501_pu, m501_tp, m502_pu, 
             ...
             m544_tp, m560_pu, m560_tp, m561_pu, 
