...
En 2020 se observa que 35,8% de los hogares están compuestos por una pareja con hijos/as, 18,1% son unipersonales, 17,9% compuestos por una preja sin hijos/as y 11,4% son monoparentales femeninos. En una menor proporción se encuentran los otros tipos de hogares. 
...
g1 <- 
  base %>% filter((NOMINDICADOR == "Distribución porcentual de los hogares según tipo de hogar (Unipersonal)"|
                  ...
                  NOMINDICADOR =="Distribución porcentual de los hogares según tipo de hogar (Extendido con núcleo monoparental)"|
                  NOMINDICADOR =="Distribución porcentual de los hogares según tipo de hogar (Sin núcleo)"), 
                  URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "QUINTIL 1"|QUINTIL == "QUINTIL 2"|QUINTIL == "QUINTIL 3"|QUINTIL == "QUINTIL 4"|QUINTIL == "QUINTIL 5", FECHA==max(FECHA)) %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
  mutate(UNIDAD = case_when(
    NOMINDICADOR == "Distribución porcentual de los hogares según tipo de hogar (Unipersonal)" ~ "Unipersonal",
    NOMINDICADOR =="Distribución porcentual de los hogares según tipo de hogar (Pareja sin hijos)" ~ "Pareja sin hijos",
...
<div style="text-align: justify">
En el siguiente gráfico puede observarse que en 2020 la mayoría de hogares en los que residen menores de 15 años son biparentales (65%), seguido de hogares monoparentales femeninos (13%) y de extendidos o compuestos (12%). 
...
A partir del gráfico es posible observar que entre 2006 y 2020 se produce una disminución del porcentaje de hogares con modelo de proveedor tradicional y, como contracara, un aumento del porcentaje de hogares con modelo de doble carrera. 
...
g1 <- 
  base %>% filter((NOMINDICADOR == "Distribución porcentual de los hogares biparentales según modelo de pareja (Proveedor tradicional)"|
                  ...
                  NOMINDICADOR =="Distribución porcentual de los hogares biparentales según modelo de pareja (Residual)"), URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "TODOS") %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
  mutate(UNIDAD = case_when(
...
Considerando el modelo de proveedor de los hogares según el quintil de ingresos hay dos aspectos a destacar. Por un lado, el porcentaje de hogares con modelo de proveedor tradicional disminuye a medida que aumentan los ingresos de los hogares, pasando de 45,5% en los hogares del primer quintil de ingresos a 9,9% en los del quinto quintil. Del otro lado, los hogares con modelo de doble carrera aumentan el porcentaje conforme aumenta el quintil de ingresos (17,0% en el primer quintil y 37,3% en el quinto quintil).   
...
g1 <- 
  base %>% filter((NOMINDICADOR == "Distribución porcentual de los hogares biparentales según modelo de pareja (Proveedor tradicional)"|
                  ...
                  NOMINDICADOR =="Distribución porcentual de los hogares biparentales según modelo de pareja (Inversión de roles)"|
                  NOMINDICADOR =="Distribución porcentual de los hogares biparentales según modelo de pareja (Inversión de roles modificado)"|
                  NOMINDICADOR =="Distribución porcentual de los hogares biparentales según modelo de pareja (Residual)"), URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "QUINTIL 1"|QUINTIL == "QUINTIL 2"|QUINTIL == "QUINTIL 3"|QUINTIL == "QUINTIL 4"|QUINTIL == "QUINTIL 5", FECHA==max(FECHA)) %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
  mutate(UNIDAD = case_when(
    NOMINDICADOR == "Distribución porcentual de los hogares biparentales según modelo de pareja (Proveedor tradicional)" ~ "Proveedor tradicional",
    NOMINDICADOR =="Distribución porcentual de los hogares biparentales según modelo de pareja (Proveedor modificado)" ~ "Proveedor modificado",
...
En el siguiente gráfico se observa que mientras el porcentaje de personas solteras, divorciadas o separadas y viudas se mantiene relativamente estable en el período presentado, el porcentaje de personas casadas diminuye en 8 puntos porcentuales, mientras el porcentaje de personas en unión libre aumenta en la misma magnitud.  
...
NOMINDICADOR =="Distribución porcentual de las personas según estado conyugal (Divorciada/o o serparada/0)"|
NOMINDICADOR =="Distribución porcentual de las personas según estado conyugal (Viuda/o)"|
NOMINDICADOR =="Distribución porcentual de las personas según estado conyugal (Soltera/o)"), URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "TODOS") %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
  mutate(UNIDAD = case_when(
...
NOMINDICADOR =="Distribución porcentual de las personas según estado conyugal (Divorciada/o o serparada/0)" ~ "Divorciada/o o separada/o",
...
Es posible observar que el porcentaje de hogares con jefatura femenina aumenta 14 puntos porcentuales entre 2006 y 2020, pasando de 33,2% a 47,1%. Por su parte, puede verse que en el localidades mayores a 5.000 habitantes es donde el porcentaje de hogares con jefatura femenina es mayor, seguido por las localidades menores de 5.000 habitabtes y, luego, el área rural dispersa.  
...
NOMINDICADOR =="Distribución porcentual de los hogares según sexo del jefe/a (Mujer)"), URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "TODOS") %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
  mutate(UNIDAD = case_when(
...
FECHA>2005, SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "TODOS", URBANORURALUY == "URBANO (MENOS DE 5.000 HABITANTES)"|URBANORURALUY == "URBANO (MÁS DE 5.000 HABITANTES)"|URBANORURALUY == "RURAL DISPERSO"|URBANORURALUY == "TOTAL PAÍS") %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
  mutate(UNIDAD = case_when(
...
#===============================================================================
g1 <- 
  base %>% filter(NOMINDICADOR == "Porcentaje de hogares en los que residen menores entre 0 y 17 años de edad", URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS"|SEXO=="VARONES"|SEXO=="MUJERES", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR))*100,1)) %>% 
  mutate(UNIDAD = case_when(
  ...
  ylim(0, 60) +
  scale_x_continuous(breaks=seq(2006, 2020, 2), limits=c(2006,2020))  +
  theme_minimal() +
  labs(
    color = "",
    title = "",
...
#===============================================================================
g1 <- 
base %>% filter(NOMINDICADOR == "Porcentaje de hogares en los que residen menores entre 0 y 17 años de edad", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "QUINTIL 1"|QUINTIL == "QUINTIL 2"|QUINTIL == "QUINTIL 3"|QUINTIL == "QUINTIL 4"|QUINTIL == "QUINTIL 5", URBANORURALUY == "TOTAL PAÍS") %>%
mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
mutate(UNIDAD = case_when(
QUINTIL == "QUINTIL 1"~"Quintil 1", QUINTIL == "QUINTIL 2"~"Quintil 2",QUINTIL == "QUINTIL 3"~ "Quintil 3", QUINTIL == "QUINTIL 4"~"Quintil 4", QUINTIL == "QUINTIL 5"~"Quintil 5"))  %>%
...
#===============================================================================
g1 <- 
  base %>% filter(CODIND==513, NOMINDICADOR == "Porcentaje de hogares en los que residen mayores de 64 años", URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS"|SEXO=="VARONES"|SEXO=="MUJERES", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR))*100,1)) %>% 
  mutate(UNIDAD = case_when(
  SEXO =="VARONES" ~ "Varones", SEXO == "MUJERES" ~ "Mujeres", SEXO=="TODOS" ~ "Total"))  %>%
  mutate(UNIDAD = factor(UNIDAD, levels = c("Mujeres", "Varones", "Total")))  %>%
...
```{r}
t1 <- 
  base %>% filter(NOMINDICADOR == "Porcentaje de hogares en los que residen mayores de 64 años", URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS"|SEXO=="VARONES"|SEXO=="MUJERES", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR))*100,1)) %>% 
  mutate(UNIDAD = case_when(
  SEXO =="VARONES" ~ "Varones", SEXO == "MUJERES" ~ "Mujeres", SEXO=="TODOS" ~ "Total"))  %>%
  rename(ANIO = FECHA)
...
#===============================================================================
g1 <- 
base %>% filter(NOMINDICADOR == "Porcentaje de hogares en los que residen mayores de 64 años", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "QUINTIL 1"|QUINTIL == "QUINTIL 2"|QUINTIL == "QUINTIL 3"|QUINTIL == "QUINTIL 4"|QUINTIL == "QUINTIL 5", URBANORURALUY == "TOTAL PAÍS") %>%
mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
mutate(UNIDAD = case_when(
QUINTIL == "QUINTIL 1"~"Quintil 1", QUINTIL == "QUINTIL 2"~"Quintil 2",QUINTIL == "QUINTIL 3"~ "Quintil 3", QUINTIL == "QUINTIL 4"~"Quintil 4", QUINTIL == "QUINTIL 5"~"Quintil 5"))  %>%
mutate(UNIDAD = factor(UNIDAD, levels = c("Quintil 1", "Quintil 2", "Quintil 3", "Quintil 4", "Quintil 5")))  %>%
...
g1 <- 
  base %>% filter((NOMINDICADOR=="Porcentaje de personas que en su primer embarazo o el de su pareja querían tener un hijo en ese momento, querían más adelante o no querían (Quería)"|
                  ...
                  URBANORURALUY == "TOTAL PAÍS", ASCENDENCIA == "TODOS", QUINTIL == "TODOS", EDAD_HIJ=="TODOS") %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
...
g1 <- 
  base %>% filter((NOMINDICADOR=="Porcentaje de personas según edad a la que tuvieron primer hijo y a la que le hubiese gustado tener  (MENOR)"|
                  ...
                  NOMINDICADOR=="Porcentaje de personas según edad a la que tuvieron primer hijo y a la que le hubiese gustado tener  (MAYOR)"),                   URBANORURALUY == "TOTAL PAÍS", ASCENDENCIA == "TODOS", QUINTIL == "TODOS", EDAD_HIJ=="TODOS") %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
...
La tasa específica de fecundidad adolescente es un indicador que da cuenta de la evolución del embarazo adolescente. Este indicador presenta un aumento de 10 puntos porcentuales entre 1996 y 2013, pasado de 70,5 a 60,9 cada mil mujeres entre 15 y 19 años. A partir de dicho año y hasta 2020, se asiste a una disminución marcada y sostenida, alcanzando en 2020 el valor de 28 cada mil mujeres entre 15 y 19 años de edad.    
...
NOMINDICADOR=="Tasa de participación de mujeres y varones entre 14 y 49 años sin menores en el hogar (Mujer)", URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR))*100,1)) %>%
  rename(SEXO_ANT=SEXO) %>%
...
#===============================================================================
g1 <- 
  base %>% filter(NOMINDICADOR == "Tasa de asistencia a la educación inicial de niños/as de 0 a 2 años", URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR))*100,1)) %>% 
  ggplot(aes(x = FECHA, y = VALOR)) +
...
#===============================================================================
g1 <- 
  base %>% filter(NOMINDICADOR == "Tasa de asistencia a la educación de niños/as de 3 a 5 años", URBANORURALUY == "URBANO (MÁS DE 5.000 HABITANTES)", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR))*100,1)) %>% 
  ggplot(aes(x = FECHA, y = VALOR)) +
  geom_line(aes(group = 1, color = NOMINDICADOR))+
  scale_color_manual(
...
URBANORURALUY == "TOTAL PAÍS"| URBANORURALUY=="Montevideo"| URBANORURALUY=="Interior urbano", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL == "TODOS") %>%
  mutate(VALOR = round(as.numeric(VALOR)*100,1)) %>% 
...
URBANORURALUY=="Interior urbano" ~ "Interior urbano"))  %>%
  mutate(UNIDAD = factor(UNIDAD, levels = c("Montevideo", "Interior urbano", "Total país")))  %>%
  mutate(FECHA = factor(FECHA, levels = c("2013", "2018")))  %>%
  ggplot(aes(x = UNIDAD, y = VALOR, fill=UNIDAD)) +
  geom_bar(stat="identity", width=0.3)+
  scale_fill_manual(
  ...
  facet_wrap(~FECHA) +
  ylim(0, 75) +
  scale_x_discrete(labels = c("Montevideo", "Interior urbano", "Total país")) +
  theme_minimal() +
  theme(legend.position="none") +
  labs(
    color = "",
...
NOMINDICADOR=="Porcentaje de niños entre 13 y 17 años sin cobertura de salud", URBANORURALUY == "URBANO (MÁS DE 5.000 HABITANTES)", FECHA>1990, SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR))*100,1)) %>% 
...
ggplot(aes(x = FECHA, y = VALOR)) +
  ...
  ylim(0, 15) +
  scale_x_continuous(breaks=seq(1991, 2020, 2), limits=c(1991,2020))  +
  theme_minimal() +
  labs(
    color = "",
    title = "",
...
<div style="text-align: justify">
El siguiente indicador da cuenta de la cantidad de defunciones de menores de 1 año y menores de 5 años cada 1000 habitantes. Es posible observar que desde 1984 hasta 2020 ambas tasas se han reducido sustancialmente. La tasa de mortalidad para niños/as menores de 1 año pasa de 30,1 a 6,2 en el período considerado, mientras la tasa de mortalidad para niños/as menores de 5 años pasa de 34,1 a 6,9. 
...
NOMINDICADOR=="Tasa de mortalidad infantil (menor a 5 años)", URBANORURALUY == "TOTAL PAÍS", SEXO == "TODOS", ASCENDENCIA == "TODOS", QUINTIL== "TODOS") %>%
  mutate(VALOR = round((as.numeric(VALOR)),1)) %>% 
...
ggplot(aes(x = FECHA, y = VALOR)) +
  ...
  scale_color_manual(
    values = c("darkorange", 639)) +
  ylim(0, 40) +
  scale_x_continuous(breaks=seq(1984, 2020, 2), limits=c(1984,2020))  +
  theme_minimal() +
  labs(
    color = "",
    title = "",
