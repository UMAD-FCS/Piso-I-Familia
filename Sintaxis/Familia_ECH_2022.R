...
ech22          <- rio::import("Bases/ECH_2022.csv")

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #

ech22 <- ech22 %>% dplyr::mutate(bc_correlat = ID)

ech22 <- ech22 %>% dplyr::mutate(jefe = case_when(e30==1 ~ 1, e30!=1 ~ 0))

ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefe=sum(jefe)) %>% as.data.frame()


### Generación de nuevas variables ###

# Ingresos
ech22 <- ech22 %>% dplyr::mutate(y_pc       =  ht11 / HT19 )                      #Ingreso per-cápita
ech22 <- ech22 %>% dplyr::mutate(y_pc_svl   =  (ht11 - ht13) / HT19)              #Ingreso per-cápita sin valor locativo

# Quintil de ingresos
ech22_h <- ech22 %>% distinct(ID, .keep_all = TRUE)
ech22_h <- ech22_h %>% dplyr::mutate(quintilesy = statar::xtile(y_pc, n=5, wt = w_ano))
ech22_h <- ech22_h[,c("ID","quintilesy")]
ech22 <- merge(ech22, ech22_h, by = "ID")

# Pobreza auxiliar
ech22 <- ech22 %>% dplyr::mutate(pobre_aux = case_when(pobre == 0 ~ 2,
                                                     pobre == 1 ~ 1))
                                                   

# Región
ech22 <- ech22 %>% dplyr::mutate(bd_region = case_when(region_4 == 1 | region_4 == 2 ~ 1,
                                                  region_4 == 3 ~ 2,
                                                  region_4 == 4 ~ 3))

# Renombro edad
ech22 <- ech22 %>% dplyr::mutate(bc_pe3 = e27)

# Sexo
ech22 <- ech22 %>% dplyr::mutate(bc_pe2 = e26)

# Ascendencia afro
ech22 <- ech22 %>% dplyr::mutate(bd_e29_1 = e29_1)


# Sexo del jefe/a de hogar
ech22 <- ech22[order(ech22$ID, ech22$e30, decreasing = FALSE), ]
ech22_h <- ech22 %>% distinct(ID, .keep_all = TRUE)
ech22_h <- ech22_h %>% dplyr::mutate(sexojefe = case_when(e30 == 1 & bc_pe2 == 1 ~ 1,
                                                        e30 == 1 & bc_pe2 == 2 ~ 2,
                                                        e30 != 1 ~ 99))
ech22_h <- ech22_h[,c("ID","sexojefe")]

ech22 <- merge(ech22, ech22_h, by = "ID")
ech22 <- ech22 %>% dplyr::mutate(sexojefe1 = case_when(sexojefe==1 ~ 1, sexojefe!=1 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(sexojefe2 = case_when(sexojefe==2 ~ 1, sexojefe!=2 ~ 0))

#Tipo de hogar

ech22 <- ech22 %>% dplyr::mutate(bc_pe4 = case_when(e30==1 ~ 1, e30==2 ~ 2, e30 ==3|e30==4|e30==5 ~ 3, e30==6|e30==7 ~ 4, 
                                                  e30==8|e30==9|e30==10|e30==11|e30==12 ~ 5, e30==13 ~ 6, e30==14 ~ 7))
ech22 <- ech22 %>% dplyr::mutate(jefe = case_when(bc_pe4==1 ~ 1, bc_pe4!=1 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(esposo_companero = case_when(bc_pe4==2 ~ 1, bc_pe4!=2 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(hijos = case_when(bc_pe4==3 ~ 1, bc_pe4!=3 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(otro_pariente = case_when(bc_pe4==4|bc_pe4==5 ~ 1, bc_pe4!=4&bc_pe4!=5 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(otro_nopariente = case_when(bc_pe4==6 ~ 1, bc_pe4!=6 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(servicio_domestico = case_when(bc_pe4==7 ~ 1, bc_pe4!=7 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(jefatura_femenina = case_when(bc_pe4==1&bc_pe2==2 ~ 1, bc_pe4!=1|bc_pe2!=2 ~ 0))

ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefe=sum(jefe)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumesposo_companero=sum(esposo_companero)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumhijo=sum(hijos)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumotro_pariente=sum(otro_pariente)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumno_pariente=sum(otro_nopariente)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumservicio_domestico=sum(servicio_domestico)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefatura_femenina=sum(jefatura_femenina)) %>% as.data.frame()
...
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar = case_when(sumesposo_companero==0 & sumhijo==0 & sumno_pariente==0 & sumotro_pariente==0 ~ 1, 
...
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar1 = case_when(tipo_hogar==1 ~ 1)) 
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar2 = case_when(tipo_hogar==2 ~ 1))
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar3 = case_when(tipo_hogar==3 ~ 1)) 
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar4 = case_when(tipo_hogar==4 ~ 1)) 
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar5 = case_when(tipo_hogar==5 ~ 1)) 
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar6 = case_when(tipo_hogar==6 ~ 1)) 
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar7 = case_when(tipo_hogar==7 ~ 1))
ech22 <- ech22 %>% dplyr::mutate(tipo_hogar8 = case_when(tipo_hogar==8 ~ 1))
ech22 <- mutate_at(ech22, c("tipo_hogar1", "tipo_hogar2", "tipo_hogar3", "tipo_hogar4", "tipo_hogar5","tipo_hogar6", "tipo_hogar7", "tipo_hogar8"), ~replace(., is.na(.), 0))


#Ciclo de vida del hogar
ech22 <- ech22 %>% dplyr::mutate(mujmen40 = case_when((bc_pe4==1 | bc_pe4==2) & bc_pe2==2 & bc_pe3<40 ~ 1, 
                                                     (bc_pe4!=1 & bc_pe4!=2) | bc_pe2!=2 | bc_pe3>=40 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(mujmay40 = case_when((bc_pe4==1 | bc_pe4==2) & bc_pe2==2 & bc_pe3>=40 ~ 1, 
                                                     (bc_pe4!=1 & bc_pe4!=2) | bc_pe2!=2 | bc_pe3<40 ~ 0))
ech22 <- ech22 %>% dplyr::mutate(hijo_men5 = case_when(hijos==1 & bc_pe3<6 ~ 1, 
                                                      (hijos!=1 | bc_pe3>=6 ~ 0)))
ech22 <- ech22 %>% dplyr::mutate(hijo_6a12 = case_when(hijos==1 & bc_pe3>5&bc_pe3<13 ~ 1, 
                                                     (hijos!=1 | (bc_pe3<6 | bc_pe3>12) ~ 0)))
ech22 <- ech22 %>% dplyr::mutate(hijo_may12 = case_when(hijos==1 & bc_pe3>12 ~ 1, 
                                                      (hijos!=1 | (bc_pe3<13) ~ 0)))
ech22 <- ech22 %>% dplyr::mutate(hijo_menos12 = case_when(hijos==1 & (hijo_6a12==1 | hijo_men5==1) ~ 1, 
                                                        (hijos!=1 | (hijo_6a12!=1 & hijo_men5!=1) ~ 0)))
ech22 <- ech22 %>% dplyr::mutate(hijo_13y18 = case_when(hijos==1 & (bc_pe3>12 & bc_pe3<19) ~ 1, 
                                                      (hijos!=1 | (bc_pe3<13 | bc_pe3>18) ~ 0)))
ech22 <- ech22 %>% dplyr::mutate(hijo_may18 = case_when(hijos==1 & bc_pe3>18 ~ 1, 
                                                      (hijos!=1 | bc_pe3<19 ~ 0)))
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumhijo_men5 =sum(hijo_men5)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumhijo_6a12 =sum(hijo_6a12)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumhijo_may12 =sum(hijo_may12)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumhijo_menos12 =sum(hijo_menos12)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumhijo_13y18 =sum(hijo_13y18)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumhijo_may18 =sum(hijo_may18)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(summujmen40 =sum(mujmen40)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(summujmay40 =sum(mujmay40)) %>% as.data.frame()
...
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida = case_when(sumesposo_companero>=1 & sumhijo==0 & summujmen40==1 ~ 1, 
...
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida1 = case_when(ciclo_vida==1 ~ 1, ciclo_vida!=1 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida2 = case_when(ciclo_vida==2 ~ 1, ciclo_vida!=2 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida3 = case_when(ciclo_vida==3 ~ 1, ciclo_vida!=3 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida4 = case_when(ciclo_vida==4 ~ 1, ciclo_vida!=4 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida5 = case_when(ciclo_vida==5 ~ 1, ciclo_vida!=5 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida6 = case_when(ciclo_vida==6 ~ 1, ciclo_vida!=6 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(ciclo_vida7 = case_when(ciclo_vida==7 ~ 1, ciclo_vida!=7 ~ 0)) 
ech22 <- mutate_at(ech22, c("ciclo_vida1", "ciclo_vida2", "ciclo_vida3", "ciclo_vida4", "ciclo_vida5","ciclo_vida6", "ciclo_vida7"), ~replace(., is.na(.), 0))

### Modelo de pareja
ech22 <- ech22 %>% dplyr::mutate(bc_pobp = POBPCOAC)
ech22 <- ech22 %>% dplyr::mutate(bc_horas = f85+f98)
ech22 <- ech22 %>% dplyr::mutate(bc_horas_1 = f85)

#generamos la variable que identifica hogares en donde hay una pareja 

ech22 <- ech22 %>% dplyr::mutate(biparentales = case_when(sumesposo_companero>0 ~ 1, sumesposo_companero==0 ~ 0))
...
ech22 <- ech22 %>% dplyr::mutate(jefeocup_tc_v = case_when(bc_pobp==2 & (bc_horas>39 | bc_horas_1>39) & jefe==1 & bc_pe2==1&biparentales==1 ~ 1))

#JEFE Ocupado tiempo completo_mujer*
ech22 <- ech22 %>% dplyr::mutate(jefeocup_tc_m = case_when(bc_pobp==2 & (bc_horas>39 | bc_horas_1>39) & jefe==1 & bc_pe2==2&biparentales==1 ~ 1))

#CONYUGE Ocupado tiempo completo*
ech22 <- ech22 %>% dplyr::mutate(conyocup_tc_v = case_when(bc_pobp==2 & (bc_horas>39 | bc_horas_1>39) & esposo_companero==1 & bc_pe2==1&biparentales==1 ~ 1))
ech22 <- ech22 %>% dplyr::mutate(conyocup_tc_m = case_when(bc_pobp==2 & (bc_horas>39 | bc_horas_1>39) & esposo_companero==1 & bc_pe2==2&biparentales==1 ~ 1))

#JEFE Ocupado medio tiempo_varón*
ech22 <- ech22 %>% dplyr::mutate(jefeocup_mt_v = case_when(bc_pobp==2 & bc_horas<40 & jefe==1 & bc_pe2==1&biparentales==1 ~ 1))

#JEFE Ocupado medio tiempo_mujer*
ech22 <- ech22 %>% dplyr::mutate(jefeocup_mt_m = case_when(bc_pobp==2 & bc_horas<40& jefe==1 & bc_pe2==2&biparentales==1 ~ 1))

#CONYUGE Ocupado medio tiempo_varón*
ech22 <- ech22 %>% dplyr::mutate(conyocup_mt_v = case_when(bc_pobp==2 & bc_horas<40& esposo_companero==1 & bc_pe2==1&biparentales==1 ~ 1))

#CONYUGE Ocupado medio tiempo_mujer*
ech22 <- ech22 %>% dplyr::mutate(conyocup_mt_m = case_when(bc_pobp==2 & bc_horas<40& esposo_companero==1 & bc_pe2==2&biparentales==1 ~ 1))

#JEFE Inactivo o desempleado_varón*
ech22 <- ech22 %>% dplyr::mutate(jefeinact_desoc_v = case_when(bc_pobp>2 & bc_pobp<12 & jefe==1 & bc_pe2==1&biparentales==1 ~ 1))

#JEFE Inactivo o desempleado_mujer*
ech22 <- ech22 %>% dplyr::mutate(jefeinact_desoc_m = case_when(bc_pobp>2 & bc_pobp<12 & jefe==1 & bc_pe2==2&biparentales==1 ~ 1))

#CONYUGE Inactivo o desempleado_varón*
ech22 <- ech22 %>% dplyr::mutate(conyinact_desoc_v = case_when(bc_pobp>2 & bc_pobp<12 & esposo_companero==1 & bc_pe2==1&biparentales==1 ~ 1))

#CONYUGE Inactivo o desempleado_mujer*
ech22 <- ech22 %>% dplyr::mutate(conyinact_desoc_m = case_when(bc_pobp>2 & bc_pobp<12 & esposo_companero==1 & bc_pe2==2&biparentales==1 ~ 1))

ech22 <- mutate_at(ech22, c("jefeocup_tc_v", "jefeocup_tc_m", "conyocup_tc_v", "conyocup_tc_m", "jefeocup_mt_v", "jefeocup_mt_m", 
...
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefeocup_tc_m=sum(jefeocup_tc_m)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefeocup_tc_v=sum(jefeocup_tc_v)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumconyocup_tc_m=sum(conyocup_tc_m)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumconyocup_tc_v=sum(conyocup_tc_v)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefeocup_mt_m=sum(jefeocup_mt_m)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefeocup_mt_v=sum(jefeocup_mt_v)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumconyocup_mt_v=sum(conyocup_mt_v)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumconyocup_mt_m=sum(conyocup_mt_m)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat)  %>% mutate(sumjefeinact_desoc_m=sum(jefeinact_desoc_m)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumjefeinact_desoc_v=sum(jefeinact_desoc_v)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumconyinact_desoc_m=sum(conyinact_desoc_m)) %>% as.data.frame()
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(sumconyinact_desoc_v=sum(conyinact_desoc_v)) %>% as.data.frame()
...
ech22 <- ech22 %>% dplyr::mutate(modelo_pareja = case_when(((sumjefeocup_tc_v==1 & sumconyinact_desoc_m==1)|(sumconyocup_tc_v==1 & sumjefeinact_desoc_m==1)|(sumjefeocup_mt_v==1 & sumconyinact_desoc_m==1)|(sumconyocup_mt_v==1 & sumjefeinact_desoc_m==1))&biparentales==1 ~ 1, 
...
ech22 <- ech22 %>% dplyr::mutate(modelo_pareja1 = case_when(modelo_pareja==1 ~ 1, modelo_pareja!=1 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(modelo_pareja2 = case_when(modelo_pareja==2 ~ 1, modelo_pareja!=2 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(modelo_pareja3 = case_when(modelo_pareja==3 ~ 1, modelo_pareja!=3 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(modelo_pareja4 = case_when(modelo_pareja==4 ~ 1, modelo_pareja!=4 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(modelo_pareja5 = case_when(modelo_pareja==5 ~ 1, modelo_pareja!=5 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(modelo_pareja6 = case_when(modelo_pareja==6 ~ 1, modelo_pareja!=6 ~ 0)) 
ech22 <- mutate_at(ech22, c("modelo_pareja1", "modelo_pareja2", "modelo_pareja3", "modelo_pareja4", "modelo_pareja5","modelo_pareja6"), ~replace(., is.na(.), 0))

####Estado civil
ech22 <- ech22 %>% dplyr::mutate(bc_pe5 = case_when(e35==2 | e35==3 | e35==6 | e35==7 ~ 1, 
                                                    e35==4 | e35==5 ~ 2,
                                                    e35==0 & (e36==1 | e36==2 | e36==3) ~ 3,
                                                    e35==0 & (e36==4 | e36==6) ~ 4,
                                                    e35==0 & e36==5 ~ 5)) 

ech22 <- ech22 %>% dplyr::mutate(estado_civil1 = case_when(bc_pe5==1 ~ 1, bc_pe5!=1 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(estado_civil2 = case_when(bc_pe5==2 ~ 1, bc_pe5!=2 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(estado_civil3 = case_when(bc_pe5==3 ~ 1, bc_pe5!=3 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(estado_civil4 = case_when(bc_pe5==4 ~ 1, bc_pe5!=4 ~ 0)) 
ech22 <- ech22 %>% dplyr::mutate(estado_civil5 = case_when(bc_pe5==5 ~ 1, bc_pe5!=5 ~ 0)) 
ech22 <- mutate_at(ech22, c("estado_civil1", "estado_civil2", "estado_civil3", "estado_civil4", "estado_civil5"), ~replace(., is.na(.), 0))


# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
#Asistencia a centros educativos
ech22 <- ech22 %>% dplyr::mutate(asiste = case_when(e49==3 ~ 1, e49!=3 ~ 0)) 


# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
###Menores de 15 
ech22 <- ech22 %>% dplyr::mutate(men15 = case_when(bc_pe3<15 ~ 1, bc_pe3>=15 ~ 0)) 
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(men15h=max(men15)) %>% as.data.frame()

###Menores de 18 
ech22 <- ech22 %>% dplyr::mutate(men0a4 = case_when(bc_pe3<5 ~ 1, bc_pe3>=5 ~ 0)) 
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(men0a4h=max(men0a4)) %>% as.data.frame()

ech22 <- ech22 %>% dplyr::mutate(men5a12 = case_when(bc_pe3>4&bc_pe3<13 ~ 1, bc_pe3>=12|bc_pe3<5 ~ 0)) 
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(men5a12h=max(men5a12)) %>% as.data.frame()

ech22 <- ech22 %>% dplyr::mutate(men13a17 = case_when(bc_pe3>12&bc_pe3<18 ~ 1, bc_pe3<13|bc_pe3>=18 ~ 0)) 
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(men13a17h=max(men13a17)) %>% as.data.frame()

ech22 <- ech22 %>% dplyr::mutate(men18 = case_when(bc_pe3<18 ~ 1, bc_pe3>=18 ~ 0)) 
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(men18h=max(men18)) %>% as.data.frame()

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
### Menores de 13 en el hogar
ech22 <- ech22 %>% dplyr::mutate(menor13 = case_when(bc_pe3<13 ~ 1, bc_pe3>=13 ~ 0))
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(menor13H=max(menor13)) %>% as.data.frame()

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
### Menores de 4 en el hogar
ech22 <- ech22 %>% dplyr::mutate(menor4 = case_when(bc_pe3<4 ~ 1, bc_pe3>=4 ~ 0))
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(menor4H=max(menor4)) %>% as.data.frame()

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
### Menores de 7 en el hogar
ech22 <- ech22 %>% dplyr::mutate(menor7 = case_when(bc_pe3<7 ~ 1, bc_pe3>=7 ~ 0))
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(menor7H=max(menor7)) %>% as.data.frame()

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
###Mayores de 64  
ech22 <- ech22 %>% dplyr::mutate(may64 = case_when(bc_pe3>64 ~ 1, bc_pe3<=64 ~ 0)) 
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(may64h=max(may64)) %>% as.data.frame()


# Tramo de edad
ech22 <- ech22 %>% dplyr::mutate(tramo_edad = case_when(bc_pe3>=0  & bc_pe3<=5  ~ 1,
                                                      ...
                                                      bc_pe3>=65 ~ 7))
ech22 <- ech22 %>% dplyr::mutate(tramo_edad2 = case_when(bc_pe3>=0  & bc_pe3<=29  ~ 1,
                                                       bc_pe3>=30  & bc_pe3<=44 ~ 2,
                                                       bc_pe3>=45 & bc_pe3<=64 ~ 3,
                                                       bc_pe3>=65 ~ 4))
ech22 <- ech22 %>% dplyr::mutate(tramo_edad3 = case_when(bc_pe3<=29  ~ 1,
                                                       bc_pe3>=30 & bc_pe3<=49 ~ 2))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
###Activos
ech22 <- ech22 %>% dplyr::mutate(activos1 = case_when(bc_pe2==1&bc_pobp>5 ~ 0, bc_pobp>=2&bc_pobp<=5&bc_pe2==1 ~ 1))
ech22 <- ech22 %>% dplyr::mutate(activos2 = case_when(bc_pe2==2&bc_pobp>5 ~ 0, bc_pobp>=2&bc_pobp<=5&bc_pe2==2 ~ 1))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
###Cobertura de salud
ech22 <- ech22 %>% dplyr::mutate(nocobert=case_when(e45_cv==7 ~ 1, e45_cv!=7 ~ 0)) 


# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
###Cantidad de integrantes en el hogar
ech22 <- ech22 %>% dplyr::mutate(identif = case_when(bc_pe4!=7 ~ 1, bc_pe4==7 ~ 0))
ech22 <- ech22 %>% group_by(bc_correlat) %>% mutate(n_int=sum(identif)) %>% as.data.frame()
ech22 <- ech22 %>% dplyr::mutate(nint1 = case_when(n_int==1~1))
ech22 <- ech22 %>% dplyr::mutate(nint2 = case_when(n_int==2~1))
ech22 <- ech22 %>% dplyr::mutate(nint3 = case_when(n_int==3~1))
ech22 <- ech22 %>% dplyr::mutate(nint4 = case_when(n_int==4~1))
ech22 <- ech22 %>% dplyr::mutate(nint5 = case_when(n_int>=5~1))

ech22 <- mutate_at(ech22, c("nint1", "nint2", "nint3", "nint4", "nint5"), ~replace(., is.na(.), 0))


### Bases menores de 18 ###                                
ech22_men <- ech22 %>%  filter(men18h >0)

### Bases a nivel hogar ###                               

ech22_h <- ech22 %>% distinct(ID, .keep_all = TRUE)
ech22_h_men <- ech22_men %>% distinct(ID, .keep_all = TRUE)

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #

### Información de muestreo ###

ech22_svy           <- srvyr::as_survey_design(ech22, ids = bc_correlat, weights = w_ano)
ech22_h_svy         <- srvyr::as_survey_design(ech22_h, ids = bc_correlat, weights = w_ano)
ech22_h_men_svy         <- srvyr::as_survey_design(ech22_h_men, ids = bc_correlat, weights = w_ano)
...
a_sem <- sapply(ech22_h_svy_1$variables %>% select(all_of(var_int)), function(x){
  ech22_h_svy_1 %>%
...
a_jefe <- function(y) {
  base <- subset(ech22_h_svy_1, sexojefe == y) 
...
a_edad <- function(y) {
  base <- subset(ech22_h_svy_1, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_quintil <- function(y) {
  base <- subset(ech22_h_svy_1, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
BASE_MOTOR <- BASE_MOTOR %>% dplyr::mutate(ANIO = 2022)
...
a_reg <- function(y) {
  base <- subset(ech22_h_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_ascen <- function(y) {
  base <- subset(ech22_h_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_pobre <- function(y) {
  base <- subset(ech22_h_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
ech22_h_svy_1_men <- ech22_h_men_svy %>%
  filter(bd_region == 1 & tipo_hogar>0)
...
var_int <- c("tipo_hogar1", "tipo_hogar2", "tipo_hogar3", "tipo_hogar4", "tipo_hogar5", "tipo_hogar6", "tipo_hogar7", "tipo_hogar8")
a_sem <- sapply(ech22_h_svy_1_men$variables %>% select(all_of(var_int)), function(x){
  ech22_h_svy_1_men %>%
    srvyr::summarise(stat = srvyr::survey_mean(x, na.rm = TRUE)) 
})
...
a_jefe <- function(y) {
  base <- subset(ech22_h_svy_1_men, sexojefe == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_edad <- function(y) {
  base <- subset(ech22_h_svy_1_men, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
# Quintil de ingreso del hogar
a_quintil <- function(y) {
  base <- subset(ech22_h_svy_1_men, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
ech22_h_men_svy_1 <- ech22_h_men_svy %>%
  filter(tipo_hogar>0)
...
var_int <- c("tipo_hogar1", "tipo_hogar2", "tipo_hogar3", "tipo_hogar4", "tipo_hogar5", "tipo_hogar6", "tipo_hogar7", "tipo_hogar8")
a_sem <- sapply(ech22_h_men_svy_1$variables %>% select(all_of(var_int)), function(x){
  ech22_h_men_svy_1 %>%
    srvyr::summarise(stat = srvyr::survey_mean(x, na.rm = TRUE)) 
})
...
a_reg <- function(y) {
  base <- subset(ech22_h_men_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_jefe <- function(y) {
  base <- subset(ech22_h_men_svy_1, sexojefe == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_edad <- function(y) {
  base <- subset(ech22_h_men_svy_1, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_ascen <- function(y) {
  base <- subset(ech22_h_men_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
# Quintil de ingreso del hogar
a_quintil <- function(y) {
  base <- subset(ech22_h_men_svy_1, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_pobre <- function(y) {
  base <- subset(ech22_h_men_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
var_int <- c("tipo_hogar1", "tipo_hogar2", "tipo_hogar3", "tipo_hogar4", "tipo_hogar5", "tipo_hogar6", "tipo_hogar7", "tipo_hogar8")
a_sem <- sapply(ech22_svy_1$variables %>% select(all_of(var_int)), function(x){
  ech22_svy_1 %>%
    srvyr::summarise(stat = srvyr::survey_mean(x, na.rm = TRUE)) 
})
...
a_sexo <- function(y) {
  base <- subset(ech22_svy_1,  bc_pe2 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_edad <- function(y) {
  base <- subset(ech22_svy_1, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
# Quintil de ingreso del hogar
a_quintil <- function(y) {
  base <- subset(ech22_svy_1, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_reg <- function(y) {
  base <- subset(ech22_svy_1, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_ascen <- function(y) {
  base <- subset(ech22_svy_1, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_pobre <- function(y) {
  base <- subset(ech22_svy_1, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
b_sem <- sapply(ech22_svy_1$variables %>% select(all_of(var_int)), function(x){
  ech22_svy_1 %>%
    srvyr::summarise(stat = srvyr::survey_mean(x, na.rm = TRUE)) 
})
...
var_int <- c("sexojefe1", "sexojefe2")
a_sem <- sapply(ech22_h_svy$variables %>% select(all_of(var_int)), function(x){
  ech22_h_svy %>%
    srvyr::summarise(stat = srvyr::survey_mean(x, na.rm = TRUE)) 
})

b_sem <- sapply(ech22_h_svy$variables %>% select(all_of(var_int)), function(x){
  ech22_h_svy %>%
    srvyr::summarise(stat = srvyr::survey_mean(x, na.rm = TRUE)) 
})
...
a_reg <- function(y) {
  base <- subset(ech22_h_svy, bd_region == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_edad <- function(y) {
  base <- subset(ech22_h_svy, tramo_edad2 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_ascen <- function(y) {
  base <- subset(ech22_h_svy, bd_e29_1 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
# Quintil de ingreso del hogar
a_quintil <- function(y) {
  base <- subset(ech22_h_svy, quintilesy == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
a_pobre <- function(y) {
  base <- subset(ech22_h_svy, pobre_aux == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
...
ech22_h_svy <- ech22_h_svy %>% dplyr::mutate(menorH=men0a4h)
...
ech22_h_svy <- ech22_h_svy %>% dplyr::mutate(menorH=men5a12h)
...
ech22_h_svy <- ech22_h_svy %>% dplyr::mutate(menorH=men13a17h)
...
ech22_h_svy <- ech22_h_svy %>% dplyr::mutate(menorH=men18h)
...
a_edad <- function(y) {
  base <- subset(ech22_svy_1, tramo_edad3 == y) 
  resultados  <-  sapply(base$variables %>% select(all_of(var_int)), function(x){
    base %>%
      srvyr::summarise(stat1 = srvyr::survey_mean(x, na.rm = TRUE))
