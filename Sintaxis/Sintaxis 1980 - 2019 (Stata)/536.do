...
* INDICADOR: Prevalencia de violencia basada en género por parte de la familia actual
* CÓDIGO:    536
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 536                  // Código de indicador
	local grupo  = 15                   // Cantidad de grupos
	local canio  = 2                    // Cantidad de años de la serie

	local filas = (`grupo') * `canio'*4.5   // Cantidad de grupos más el total por cantidad de años de la serie
...
recode VT_familia (0=.) (2=0)
recode VE_famactual12 (0=.) (2=0)
recode VF_famactual12 (0=.) (2=0)
recode VP_famactual12 (0=.) (2=0)

lab def dicotomica 0 "No" 1 "Si"
lab val VT_familia dicotomica 
lab val VE_famactual12 dicotomica 
lab val VF_famactual12 dicotomica 
lab val VP_famactual12 dicotomica 

rename VT_familia familia1
rename VP_famactual12 familia2
rename VE_famactual12 familia3
rename VF_famactual12 familia4


	foreach x of numlist 1/4 {
	mean familia`x' [aw=ponderador] 
	matrix MATR  [`i',1]= e(b)
	matrix MATR  [`i',2]=  0
	...
	foreach x of numlist 1/4 {
	mean familia`x' [aw=ponderador] if region==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
	...
	foreach x of numlist 1/4 {
	mean familia`x' [aw=ponderador] if NSE==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/2  {
	foreach x of numlist 1/4 {
	mean familia`x' [aw=ponderador] if afro==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
	...
	foreach val of numlist 1/3  {
	foreach x of numlist 1/4 {
	mean familia`x' [aw=ponderador] if nivel_edu_sig==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/4 {
	mean familia`x' [aw=ponderador] if tramo==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
...
recode VT_familia (0=.) (2=0)
recode VS_familia (0=.) (2=0)
recode VF_familia (0=.) (2=0)
recode VP_familia (0=.) (2=0)
recode VE_familia (0=.) (2=0)

lab def dicotomica 0 "No" 1 "Si"
lab val VT_familia dicotomica 
lab val VF_familia dicotomica 
lab val VS_familia dicotomica 
lab val VP_familia dicotomica 
lab val VE_familia dicotomica 

rename VT_familia familia1
rename VP_familia familia2
rename VE_familia familia3
rename VF_familia familia4
rename VS_familia familia5
...
g CODIND                 = 536
g NOMINDICADOR           = "Prevalencia de violencia basada en género por parte de la familia actual (Total)" if TIPO==1
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la familia actual (Psicológica)" if TIPO==2
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la familia actual (Económica)" if TIPO==3
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la familia actual (Física)" if TIPO==4
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la familia actual (Sexual)" if TIPO==5
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
