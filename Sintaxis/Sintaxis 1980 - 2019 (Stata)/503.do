...
* INDICADOR: Distribución porcentual de los hogares según ciclo de vida del hogar
* CÓDIGO:    503
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 503                  // Código de indicador
	local grupo  = 18                   // Cantidad de grupos
	local canio  = 15                   // Cantidad de años de la serie

	local filas = (`grupo') * `canio' * 7 // Cantidad de grupos más el total por cantidad de años de la serie
	matrix def       MATR= J(`filas',4,.)
	matrix colnames  MATR= VALOR AUXILIAR ANIO CICLO

	foreach anio of numlist $seieTOT  {
    use "$bases\fusionada_personasyhogares_`anio'.dta", clear
	do "C:\Users\Usuario\Dropbox\UMAD\Sociodemografico\Familia\Sintaxis\Auxiliares\Ciclo de vida.do"
	...
	ta ciclo_vida, gen(ciclo) 
	
	foreach x of numlist 1/7 {
	mean ciclo`x' [aw=bc_pesoan] if bc_pe4==1
	matrix MATR  [`i',1]= e(b)
	matrix MATR  [`i',2]=  0
...
/*NO se procesa país urbano para no duplicar valores*/
	...
	foreach x of numlist 1/7 {
	mean ciclo`x' [aw=bc_pesoan] if bd_region==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/7 {
	mean ciclo`x' [aw=bc_pesoan] if bc_pe2==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/7 {
	mean ciclo`x' [aw=bc_pesoan] if tramo_edad==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/2  {
	foreach x of numlist 1/7 {
	mean ciclo`x' [aw=bc_pesoan] if bd_e29_1==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/7 {
	mean ciclo`x' [aw=bc_pesoan] if bd_quintilesy==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/7 {
	mean ciclo`x' [aw=bc_pesoan] if pobre06==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
...
rename pobre_06 pobre06
	...
	local i  =  1765 // (1 + `grupo') * (`canio'-1) 
	
foreach x of numlist 1/7 {
foreach mes of numlist 1/12 {
	mean ciclo`x' if mes==`mes'&e30==1 [aw=pesomen] 
	...
	foreach val of numlist 2/3  {
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & bd_region==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/2  {
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & e26==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & tramo_edad==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & e29_1==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 0/1  {
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & pobre06==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
g CODIND                 = 503
g NOMINDICADOR           = "Distribución porcentual de los hogares según ciclo de vida del hogar (Pareja joven sin hijos)" if CICLO==1
replace NOMINDICADOR     = "Distribución porcentual de los hogares según ciclo de vida del hogar (Etapa inicial)" if CICLO==2
replace NOMINDICADOR     = "Distribución porcentual de los hogares según ciclo de vida del hogar (Expansión o crecimiento)" if CICLO==3
replace NOMINDICADOR     = "Distribución porcentual de los hogares según ciclo de vida del hogar (Consolidación)" if CICLO==4
replace NOMINDICADOR     = "Distribución porcentual de los hogares según ciclo de vida del hogar (Etapa de salida)" if CICLO==5
replace NOMINDICADOR     = "Distribución porcentual de los hogares según ciclo de vida del hogar (Pareja mayor sin hijos)" if CICLO==6
replace NOMINDICADOR     = "Distribución porcentual de los hogares según ciclo de vida del hogar (Hoagres no familiares)" if CICLO==7
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	foreach x of numlist 1/7  { 
	mean ciclo`x' [aw=bc_pesoan] if bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
	...
	foreach x of numlist 1/7  { 
	foreach val of numlist 1/2  { 
	mean ciclo`x' [aw=bc_pesoan] if bc_pe2==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/7  { 
	foreach val of numlist 1/4  {
	mean ciclo`x' [aw=bc_pesoan] if tramo_edad==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/7  { 
	foreach val of numlist 1/5  {
	mean ciclo`x' [aw=bc_pesoan] if bd_quintilesy==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
...
drop uno ypc1 quintilesy_prev
	...
	local i  =  2521 // (1 + `grupo') * (`canio'-1) 
	
foreach x of numlist 1/7 {
foreach mes of numlist 1/12 {
	mean ciclo`x' if mes==`mes'&e30==1& bc_filtloc==1 [aw=pesomen] 
	matrix aux_2020 [`mes',1]=e(b)
}
	...
	foreach val of numlist 1/2  {
	foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & e26==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & tramo_edad==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean ciclo`x' [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
