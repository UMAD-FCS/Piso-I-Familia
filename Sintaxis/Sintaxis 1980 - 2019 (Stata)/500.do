...
* INDICADOR: Distribución porcentual de los hogares según tipo de hogar
* CÓDIGO:    500
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 500                  // Código de indicador
...
g CODIND                 = 500
g NOMINDICADOR           = "Distribución porcentual de los hogares según tipo de hogar (Unipersonal)" if TIPO==1
replace NOMINDICADOR     = "Distribución porcentual de los hogares según tipo de hogar (Pareja sin hijos)" if TIPO==2
replace NOMINDICADOR     = "Distribución porcentual de los hogares según tipo de hogar (Biparental)" if TIPO==3
replace NOMINDICADOR     = "Distribución porcentual de los hogares según tipo de hogar (Monoparental femenino)" if TIPO==4
replace NOMINDICADOR     = "Distribución porcentual de los hogares según tipo de hogar (Monoparental masculino)" if TIPO==5
replace NOMINDICADOR     = "Distribución porcentual de los hogares según tipo de hogar (Extendido o compuesto)" if TIPO==6
replace NOMINDICADOR     = "Distribución porcentual de los hogares según tipo de hogar (Extendido con núcleo monoparental)" if TIPO==7
replace NOMINDICADOR     = "Distribución porcentual de los hogares según tipo de hogar (Sin núcleo)" if TIPO==8
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
