...
* INDICADOR: Porcentaje de personas según cantidad de hijos tenidos y deseados
* CÓDIGO:    526
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 526                  // Código de indicador
	...
	matrix colnames  MATR= VALOR AUXILIAR ANIO CANT
...
replace tramoed2=3 if edad_mp_hij>29&edad_mp_hij<46
	...
	g cant=1 if hr10_1<ina40_1&ina40_1!=.&hr10_1!=.&di28>3
	replace cant=2 if hr10_1==ina40_1&ina40_1!=.&hr10_1!=.
	replace cant=3 if hr10_1>ina40_1&ina40_1!=.&hr10_1!=.
	ta cant if cant!=., g(cant)
	...
	foreach x of numlist 1/3 {
	mean cant`x' [aw=peso] if region==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/2  {
	foreach x of numlist 1/3 {
	mean cant`x' [aw=peso] if sexo==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
	...
	foreach x of numlist 1/3 {
	mean cant`x' [aw=peso] if bd_tercilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/3  {
	foreach x of numlist 1/3 {
	mean cant`x' [aw=peso] if tramoed1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/3  {
	foreach x of numlist 1/3 {
	mean cant`x' [aw=peso] if tramoed2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
...
destring ANIO, replace
sort ANIO AUXILIAR CANT
drop if ANIO==.
destring CANT, replace
destring AUXILIAR, replace

g CODIND                 = 526
g NOMINDICADOR           = "Porcentaje de personas según cantidad de hijos tenidos y deseados (MENOR)" if CANT==1
replace NOMINDICADOR     = "Porcentaje de personas según cantidad de hijos tenidos y deseados (IGUAL)" if CANT==2
replace NOMINDICADOR     = "Porcentaje de personas según cantidad de hijos tenidos y deseados (MAYOR)" if CANT==3
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
