...
* INDICADOR: Porcentaje de personas según edad a la que tuvieron primer hijo y a la que le hubiese gustado tener 
* CÓDIGO:    527
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 527                  // Código de indicador
...
replace tramoed2=3 if edad_mp_hij>29&edad_mp_hij<46
	...
	g edad=1 if (edad_mp_hij-ina41_1)<-1 &ina41_1!=.&edad_mp_hij!=.
	replace edad=2 if (edad_mp_hij-ina41_1)>=-1&(edad_mp_hij-ina41_1)<=1&ina41_1!=.&edad_mp_hij!=.
	replace edad=3 if (edad_mp_hij-ina41_1)>1 &ina41_1!=.&edad_mp_hij!=.
	ta edad if edad!=., g(edad)
    ...
    *
	...
	foreach val of numlist 1/2  {
	foreach x of numlist 1/3 {
	mean edad`x' [aw=peso] if sexo==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
	...
	foreach x of numlist 1/3 {
	mean edad`x' [aw=peso] if bd_tercilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/3  {
	foreach x of numlist 1/3 {
	mean edad`x' [aw=peso] if tramoed1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/3  {
	foreach x of numlist 1/3 {
	mean edad`x' [aw=peso] if tramoed2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2015
	matrix MATR  [`i',4]=  `x'
...
g CODIND                 = 527
g NOMINDICADOR           = "Porcentaje de personas según edad a la que tuvieron primer hijo y a la que le hubiese gustado tener  (MENOR)" if EDAD==1
replace NOMINDICADOR     = "Porcentaje de personas según edad a la que tuvieron primer hijo y a la que le hubiese gustado tener  (IGUAL)" if EDAD==2
replace NOMINDICADOR     = "Porcentaje de personas según edad a la que tuvieron primer hijo y a la que le hubiese gustado tener  (MAYOR)" if EDAD==3
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
