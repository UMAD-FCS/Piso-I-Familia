...
* INDICADOR: Tasa de actividad de mujeres y varones de 14 a 49 años de edad, con presencia de menores de 4 en el hogar
* CÓDIGO:    542
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 542                  // Código de indicador
...
cap drop menor4
g menor4=(bc_pe3<4)
egen menor4H= max(menor4), by (bc_correlat)
drop if menor4H==0
...
g CODIND                 = 542
g NOMINDICADOR           = "Tasa de participación de mujeres y varones entre 14 y 49 años con presencia de menores de 4 en el hogar (Varón)" if TIPO==1
replace NOMINDICADOR     = "Tasa de participación de mujeres y varones entre 14 y 49 años con presencia de menores de 4 en el hogar (Mujer)" if TIPO==2
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
