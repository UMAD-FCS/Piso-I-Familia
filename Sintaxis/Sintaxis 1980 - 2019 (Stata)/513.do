...
* INDICADOR: Porcentaje de hogares en los que residen mayores de 64 años
* CÓDIGO:    513
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 513                  // Código de indicador
	...
	g mayor64=bc_pe3>64
	egen mayor64H=max(mayor64), by(bc_correlat)
	
	
	mean mayor64H [aw=bc_pesoan] if bc_pe4==1
	matrix MATR  [`i',1]= e(b)
	matrix MATR  [`i',2]=  0
...
/*NO se procesa país urbano para no duplicar valores*/
	...
	mean mayor64H [aw=bc_pesoan] if bd_region==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean mayor64H [aw=bc_pesoan] if bc_pe2==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean mayor64H [aw=bc_pesoan] if tramo_edad==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	9
	foreach val of numlist 1/2  {
	mean mayor64H [aw=bc_pesoan] if bd_e29_1==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean mayor64H [aw=bc_pesoan] if bd_quintilesy==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean mayor64H [aw=bc_pesoan] if pobre06==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
foreach mes of numlist 1/12 {
	mean mayor64H if mes==`mes'&e30==1 [aw=pesomen] 
	...
	foreach val of numlist 2/3  {
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & bd_region==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/2  {
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & e26==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & tramo_edad==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & e29_1==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 0/1  {
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & pobre06==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
g CODIND                 = 513
g NOMINDICADOR           = "Porcentaje de hogares en los que residen mayores de 64 años" 
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	mean mayor64H [aw=bc_pesoan] if bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
	...
	foreach val of numlist 1/2  { 
	mean mayor64H [aw=bc_pesoan] if bc_pe2==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	3
	foreach val of numlist 1/4  {
	mean mayor64H [aw=bc_pesoan] if tramo_edad==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	7
	foreach val of numlist 1/5  {
	mean mayor64H [aw=bc_pesoan] if bd_quintilesy==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
foreach mes of numlist 1/12 {
	mean mayor64H if mes==`mes'&e30==1& bc_filtloc==1 [aw=pesomen] 
	matrix aux_2020 [`mes',1]=e(b)
}
	...
	foreach val of numlist 1/2  {
	foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & e26==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & tramo_edad==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean mayor64H [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
