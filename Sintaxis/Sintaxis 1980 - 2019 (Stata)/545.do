...
* INDICADOR: Porcentaje de niños/as que asisten a centros de cuidado infantil
* CÓDIGO:    545
* GRUPOS:    Región / Tramo edad 
* FUENTE:    ENDIS
* PERÍODO:   2013, 2018
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 545                  // Código de indicador
...
*tramo de edad: rango_ed (1: menor a 1 año, 2: 1 año, 3: 2 años, 4: 3 años)
*region_n (1: montevideo, 2: interior urbano)
*quintil

g asiste=0 if ih1==2|ih2==2
replace asiste=1 if ih2==1

	mean asiste [aw=peso1] 
	matrix MATR  [`i',1]= e(b)
	matrix MATR  [`i',2]=  0
	...
	mean asiste [aw=peso1] if region_n==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	...
	mean asiste [aw=peso1] if rango_ed==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	...
	mean asiste [aw=peso1] if quintil==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
...
g asiste=0 if ih1==2|e238==2
replace asiste=1 if e238==1
...
g CODIND                 = 545
g NOMINDICADOR           = "Porcentaje de niños/as que asisten a centros de cuidado infantil" 
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
