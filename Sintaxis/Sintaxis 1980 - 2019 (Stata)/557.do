...
* INDICADOR: Porcentaje de nacidos vivos con macrosomía
* CÓDIGO:    557
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 557                  // Código de indicador
...
g bajopeso=ma10c>4000

local i=1 

	mean bajopeso [aw=peso1] 
	matrix MATR  [`i',1]= e(b)
	matrix MATR  [`i',2]=  0
	...
	mean bajopeso [aw=peso1] if region_n==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	...
	mean bajopeso [aw=peso1] if rango_ed==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
...
g CODIND                 = 557
g NOMINDICADOR           = "Porcentaje de nacidos vivos con macrosomía" 
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
