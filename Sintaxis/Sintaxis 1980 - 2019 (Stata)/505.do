...
* INDICADOR: Distribución porcentual de las personas según estado conyugal
* CÓDIGO:    505
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 505                  // Código de indicador
	...
	matrix colnames  MATR= VALOR AUXILIAR ANIO ESTCIVIL
	...
	ta bc_pe5 if bc_pe5!=.&bc_pe5>0, gen(estcivil) 
	
	foreach x of numlist 1/5 {
	mean estcivil`x' [aw=bc_pesoan] if bc_pe3>=14
	matrix MATR  [`i',1]= e(b)
	matrix MATR  [`i',2]=  0
...
/*NO se procesa país urbano para no duplicar valores*/
	...
	foreach x of numlist 1/5 {
	mean estcivil`x' [aw=bc_pesoan] if bd_region==`val'&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/5 {
	mean estcivil`x' [aw=bc_pesoan] if bc_pe2==`val'&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/5 {
	mean estcivil`x' [aw=bc_pesoan] if tramo_edad==`val'&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/2  {
	foreach x of numlist 1/5 {
	mean estcivil`x' [aw=bc_pesoan] if bd_e29_1==`val'&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/5 {
	mean estcivil`x' [aw=bc_pesoan] if bd_quintilesy==`val'&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/5 {
	mean estcivil`x' [aw=bc_pesoan] if pobre06==`val'&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
...
foreach mes of numlist 1/12 {
	mean estcivil`x' if mes==`mes'&bc_pe3>=14 [aw=pesomen] 
	...
	foreach val of numlist 2/3  {
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & bd_region==`val'&bc_pe3>=14
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/2  {
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & e26==`val'&bc_pe3>=14
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & tramo_edad==`val'&bc_pe3>=14
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & e29_1==`val'&bc_pe3>=14
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&bc_pe3>=14
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 0/1  {
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & pobre06==`val'&bc_pe3>=14
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
sort ANIO AUXILIAR ESTCIVIL
drop if ANIO==.
drop ANIO_ANT
destring ESTCIVIL, replace
destring AUXILIAR, replace

g CODIND                 = 505
g NOMINDICADOR           = "Distribución porcentual de las personas según estado conyugal(Unión libre)" if ESTCIVIL==1
replace NOMINDICADOR     = "Distribución porcentual de las personas según estado conyugal (Casada/o)" if ESTCIVIL==2
replace NOMINDICADOR     = "Distribución porcentual de las personas según estado conyugal (Divorciada/o o serparada/0)" if ESTCIVIL==3
replace NOMINDICADOR     = "Distribución porcentual de las personas según estado conyugal (Viuda/o)" if ESTCIVIL==4
replace NOMINDICADOR     = "Distribución porcentual de las personas según estado conyugal (Soltera/o)" if ESTCIVIL==5
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	foreach x of numlist 1/5  { 
	mean estcivil`x' [aw=bc_pesoan] if bc_filtloc==1&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
	...
	foreach x of numlist 1/5  { 
	foreach val of numlist 1/2  { 
	mean estcivil`x' [aw=bc_pesoan] if bc_pe2==`val' & bc_filtloc==1&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/5  { 
	foreach val of numlist 1/4  {
	mean estcivil`x' [aw=bc_pesoan] if tramo_edad==`val' & bc_filtloc==1&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/5  { 
	foreach val of numlist 1/5  {
	mean estcivil`x' [aw=bc_pesoan] if bd_quintilesy==`val' & bc_filtloc==1&bc_pe3>=14
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
...
foreach x of numlist 1/5 {
foreach mes of numlist 1/12 {
	mean estcivil`x' if mes==`mes'&bc_pe3>=14& bc_filtloc==1 [aw=pesomen] 
	matrix aux_2020 [`mes',1]=e(b)
}
	...
	foreach val of numlist 1/2  {
	foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & e26==`val'&bc_pe3>=14& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & tramo_edad==`val'&bc_pe3>=14& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean estcivil`x' [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&bc_pe3>=14& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
