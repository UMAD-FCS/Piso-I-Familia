...
* INDICADOR: Tasa de participación en las actividades de cuidados dentro del hogar
* CÓDIGO:    549
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 549                  // Código de indicador
...
foreach x of numlist 1/6  {
	mean part`x' [aw=peso_eut] if region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
...
foreach x of numlist 1/6  {
	mean part`x' [aw=peso_eut] if rango_ed==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
	...
	foreach val of numlist 1/2  {
foreach x of numlist 1/6  {
	mean part`x' [aw=peso_eut] if sexo==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
...
foreach x of numlist 1/6  {
	mean part`x' [aw=peso_eut] if bd_tercilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  2013
	matrix MATR  [`i',4]=  `x'
...
destring SUBPOBLACION, replace

g CODIND                 = 549
g NOMINDICADOR           = "Tasa de participación en las actividades de cuidados dentro del hogar (personas con discapacidad)" if SUBPOBLACION==1
replace NOMINDICADOR     = "Tasa de participación en las actividades de cuidados dentro del hogar (niños/as de 0 a 3 años)" if SUBPOBLACION==2
replace NOMINDICADOR     = "Tasa de participación en las actividades de cuidados dentro del hogar (niños/as de 4 a 5 años)" if SUBPOBLACION==3
replace NOMINDICADOR     = "Tasa de participación en las actividades de cuidados dentro del hogar (niños/as de 6 a 12 años)" if SUBPOBLACION==4
replace NOMINDICADOR     = "Tasa de participación en las actividades de cuidados dentro del hogar (niños/as de 0 a 12 años)" if SUBPOBLACION==5
replace NOMINDICADOR     = "Tasa de participación en las actividades de cuidados dentro del hogar (mayores de 65 años)" if SUBPOBLACION==6
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
