...
* INDICADOR: Participación de personas en el cuidado de niños/as fuera del horario escolar
* CÓDIGO:    547
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 547                  // Código de indicador
...
g cuida1=1 if cf2a==1
replace cuida1=0 if cf2a!=1&cf2a!=.

g cuida2=1 if cf2b==1
replace cuida2=0 if cf2b!=1&cf2b!=.

g cuida3=1 if cf2f==1|cf2g==1
replace cuida3=0 if cf2f!=1&cf2f!=.&cf2g!=1&cf2g!=.

g cuida4=1 if cf2h==1
replace cuida4=0 if cf2h!=1&cf2h!=.

g cuida5=1 if cf2d==1|cf2e==1|cf2i==1|cf2j==1
replace cuida5=0 if cf2d!=1&cf2d!=.&cf2e!=1&cf2e!=.&cf2i!=1&cf2i!=.&cf2j!=1&cf2j!=.

g cuida6=1 if cf2k==1
replace cuida6=0 if cf2k!=1&cf2k!=.
...
*1: madre, 2: padre, 3: hermane, 4: abuele, 5: otro pariente o no pariente, 6: Persona remunerado	
g cuida1=1 if ih2_ne_1==1
replace cuida1=0 if ih2_ne_1!=1&ih2_ne_1!=.

g cuida2=1 if ih2_ne_2==1
replace cuida2=0 if ih2_ne_2!=1&ih2_ne_2!=.

g cuida3=1 if ih2_ne_6==1|ih2_ne_7==1
replace cuida3=0 if ih2_ne_6!=1&ih2_ne_6!=.&ih2_ne_7!=1&ih2_ne_7!=.

g cuida4=1 if ih2_ne_8==1
replace cuida4=0 if ih2_ne_8!=1&ih2_ne_8!=.

g cuida5=1 if ih2_ne_4==1|ih2_ne_5==1|ih2_ne_9==1|ih2_ne_10==1
replace cuida5=0 if ih2_ne_4!=1&ih2_ne_4!=.&ih2_ne_5!=1&ih2_ne_5!=.&ih2_ne_9!=1&ih2_ne_9!=.&ih2_ne_10!=1&ih2_ne_10!=.

g cuida6=1 if ih2_ne_11==1
replace cuida6=0 if ih2_ne_11!=1&ih2_ne_11!=.
...
g CODIND                 = 547
g NOMINDICADOR           = "Participación de personas en el cuidado de niños/as fuera del horario escolar (Madre)" if CUIDADORA==1 
replace NOMINDICADOR     = "Participación de personas en el cuidado de niños/as fuera del horario escolar (Padre)" if CUIDADORA==2 
replace NOMINDICADOR     = "Participación de personas en el cuidado de niños/as fuera del horario escolar (Hermano/a)" if CUIDADORA==3 
replace NOMINDICADOR     = "Participación de personas en el cuidado de niños/as fuera del horario escolar (Abuelo/a)" if CUIDADORA==4 
replace NOMINDICADOR     = "Participación de personas en el cuidado de niños/as fuera del horario escolar (Otro pariente o no pariente)" if CUIDADORA==5 
replace NOMINDICADOR     = "Participación de personas en el cuidado de niños/as fuera del horario escolar (Persona remunerada)" if CUIDADORA==6 
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
