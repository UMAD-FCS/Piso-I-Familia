...
* INDICADOR: Tasa de actividad de mujeres y varones de 14 a 49 años de edad, con presencia de menores de 7 en el hogar
* CÓDIGO:    543
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 543                  // Código de indicador
...
cap drop menor7
g menor7=(bc_pe3<7)
egen menor7H= max(menor7), by (bc_correlat)
drop if menor7H==0
...
g CODIND                 = 543
g NOMINDICADOR           = "Tasa de participación de mujeres y varones entre 14 y 49 años con presencia de menores de 7 en el hogar (Varón)" if TIPO==1
replace NOMINDICADOR     = "Tasa de participación de mujeres y varones entre 14 y 49 años con presencia de menores de 7 en el hogar (Mujer)" if TIPO==2
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
