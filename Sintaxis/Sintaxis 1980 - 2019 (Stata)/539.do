...
* INDICADOR: Prevalencia de violencia basada en género por parte de la pareja o expareja a lo largo de toda la vida
* CÓDIGO:    539
* GRUPOS:    Región / Nivel socioeconómico / Tramo edad / Ascendencia étnico-racial / Nivel educativo
* FUENTE:    ENVBGG
* PERÍODO:   2013, 2019
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *PAÍS URBANO
	local i      = 1
	local codind = 539                  // Código de indicador
...
recode VTotal_parejaoex2 (0=.) (2=0) (88=.) (99=.)
recode VE_parejaoex2 (0=.) (2=0) (88=.) (99=.)
recode VF_parejaoex2 (0=.) (2=0) (88=.) (99=.)
recode VP_parejaoex2 (0=.) (2=0) (88=.) (99=.)
recode VS_parejaoex2 (0=.) (2=0) (88=.) (99=.)

lab def dicotomica 0 "No" 1 "Si"
lab val VTotal_parejaoex2 dicotomica 
lab val VE_parejaoex2 dicotomica 
lab val VF_parejaoex2 dicotomica 
lab val VP_parejaoex2 dicotomica 
lab val VS_parejaoex2 dicotomica 

rename VTotal_parejaoex2 pareja1
rename VP_parejaoex2 pareja2
rename VE_parejaoex2 pareja3
rename VF_parejaoex2 pareja4
rename VS_parejaoex2 pareja5
...
recode VT_pareja (0=.) (2=0)
recode VS_pareja (0=.) (2=0)
recode VF_pareja (0=.) (2=0)
recode VP_pareja (0=.) (2=0)
recode VE_pareja (0=.) (2=0)
recode VD_pareja (0=.) (2=0)

lab def dicotomica 0 "No" 1 "Si"
lab val VT_pareja dicotomica 
lab val VF_pareja dicotomica 
lab val VS_pareja dicotomica 
lab val VP_pareja dicotomica 
lab val VE_pareja dicotomica 
lab val VD_pareja dicotomica 

rename VT_pareja pareja1
rename VP_pareja pareja2
rename VE_pareja pareja3
rename VF_pareja pareja4
rename VS_pareja pareja5
rename VD_pareja pareja6
...
g CODIND                 = 539
g NOMINDICADOR           = "Prevalencia de violencia basada en género por parte de la pareja o expareja a lo largo de toda la vida (Total)" if TIPO==1
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la pareja o expareja a lo largo de toda la vida (Psicológica)" if TIPO==2
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la pareja o expareja a lo largo de toda la vida (Económica)" if TIPO==3
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la pareja o expareja a lo largo de toda la vida (Física)" if TIPO==4
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la pareja o expareja a lo largo de toda la vida (Sexual)" if TIPO==5
replace NOMINDICADOR     = "Prevalencia de violencia basada en género por parte de la pareja o expareja a lo largo de toda la vida (Digital)" if TIPO==6
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
