...
* INDICADOR: Distribución porcentual de los hogares con menores de 15 años según tipo de hogar
* CÓDIGO:    516
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 516                  // Código de indicador
	...
	do "C:\Users\Usuario\Dropbox\UMAD\Sociodemografico\Familia\Sintaxis\Auxiliares\Tipo hogar.do"
	ta tipo_hogar, gen(tipo) 
	cap drop men15 
	g men15=bc_pe3<15
	cap drop men15H
	egen men15H=sum(men15), by(bc_correlat)
	drop if men15H==0
	...
	mean tipo`x' [aw=bc_pesoan] if bc_pe4==1
	matrix MATR  [`i',1]= e(b)
	matrix MATR  [`i',2]=  0
...
/*NO se procesa país urbano para no duplicar valores*/
	...
	foreach x of numlist 1/8 {
	mean tipo`x' [aw=bc_pesoan] if bd_region==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
	matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/8 {
	mean tipo`x' [aw=bc_pesoan] if bc_pe2==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/8 {
	mean tipo`x' [aw=bc_pesoan] if tramo_edad==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach val of numlist 1/2  {
	foreach x of numlist 1/8 {
	mean tipo`x' [aw=bc_pesoan] if bd_e29_1==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/8 {
	mean tipo`x' [aw=bc_pesoan] if bd_quintilesy==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/8 {
	mean tipo`x' [aw=bc_pesoan] if pobre06==`val'&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
...
foreach mes of numlist 1/12 {
	mean tipo`x' if mes==`mes'&e30==1 [aw=pesomen] 
	...
	foreach val of numlist 2/3  {
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & bd_region==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/2  {
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & e26==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & tramo_edad==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & e29_1==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 0/1  {
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & pobre06==`val'&e30==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
...
g CODIND                 = 516
g NOMINDICADOR           = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Unipersonal)" if TIPO==1
replace NOMINDICADOR     = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Pareja sin hijos)" if TIPO==2
replace NOMINDICADOR     = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Biparental)" if TIPO==3
replace NOMINDICADOR     = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Monoparental femenino)" if TIPO==4
replace NOMINDICADOR     = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Monoparental masculino)" if TIPO==5
replace NOMINDICADOR     = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Extendido o compuesto)" if TIPO==6
replace NOMINDICADOR     = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Extendido con núcleo monoparental)" if TIPO==7
replace NOMINDICADOR     = "Distribución porcentual de hogares con menores de 15 años según tipo de hogar (Sin núcleo)" if TIPO==8
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	foreach x of numlist 1/8 { 
	mean tipo`x' [aw=bc_pesoan] if bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
	...
	foreach x of numlist 1/8 { 
	foreach val of numlist 1/2  { 
	mean tipo`x' [aw=bc_pesoan] if bc_pe2==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/8 { 
	foreach val of numlist 1/4  {
	mean tipo`x' [aw=bc_pesoan] if tramo_edad==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
    ...
    *
	...
	foreach x of numlist 1/8 { 
	foreach val of numlist 1/5  {
	mean tipo`x' [aw=bc_pesoan] if bd_quintilesy==`val' & bc_filtloc==1&bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    matrix MATR  [`i',4]=  `x'
...
foreach x of numlist 1/8 {
foreach mes of numlist 1/12 {
	mean tipo`x' if mes==`mes'&e30==1& bc_filtloc==1 [aw=pesomen] 
	matrix aux_2020 [`mes',1]=e(b)
}
	...
	foreach val of numlist 1/2  {
	foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & e26==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/4  {
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & tramo_edad==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
    ...
    *
	...
	foreach val of numlist 1/5  {
foreach mes of numlist 1/12 {
	mean tipo`x' [aw=pesomen] if mes==`mes' & bd_quintilesy==`val'&e30==1& bc_filtloc==1
	matrix aux_2020 [`mes',1]=e(b)
}
	matrix MATR  [`i',1]=  (aux_2020[1,1]+aux_2020[2,1]+aux_2020[3,1]+aux_2020[4,1]+ /*
						*/ aux_2020[5,1]+aux_2020[6,1]+aux_2020[7,1]+aux_2020[8,1]+ /*
