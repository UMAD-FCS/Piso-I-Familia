...
ech            <- rio::import("Bases/ECH_2025.CSV")
...
BASE_MOTOR <- BASE_MOTOR %>% dplyr::mutate(ANIO = 2025)
...
rio::export(BASE, "Data/PRUEBAS/ECH_2025.xlsx" )


Base_Motor_Familia  <- rio::import("Data/Respaldo bases anteriores/Base_motor_23062025.xls")

Base_Motor_Familia_2026  <- rbind(Base_Motor_Familia, BASE)

rio::export(Base_Motor_Familia_2026, "Data/Base_Motor_familia.xlsx" )
