...
ech            <- rio::import("Bases/ECH_2024.CSV")
...
BASE_MOTOR <- BASE_MOTOR %>% dplyr::mutate(ANIO = 2024)
...
rio::export(BASE, "Data/PRUEBAS/ECH_2024.xlsx" )


# Base_Motor_Familia  <- rio::import("Data/Respaldo bases anteriores/Base_motor_20052024.xls")
# 
# Base_Motor_Familia_2025  <- rbind(Base_Motor_Familia, BASE)
# 
# 
# rio::export(Base_Motor_Familia_2025, "Data/Base_Motor_familia.xlsx" )
